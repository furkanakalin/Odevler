  ...
  8) Email'in, "Testing"ı içinde bulundurduğunu doğrulayın.
    ...
    */
    ...
    public void Test(){
        ...
        WebElement adress = driver.findElement(By.xpath("//*[@placeholder='Current Address']"));
        adress.sendKeys("Testing Current Address");
        MyFunc.Bekle(1);

        WebElement peradress = driver.findElement(By.xpath("//*[@id='permanentAddress-wrapper'] //textarea[@rows='5']"));
